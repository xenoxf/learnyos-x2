...
export const ThemeSelector: React.FC = () => {
  ...
  const getPreviewStyle = (themeName: string) => {
    switch (themeName) {
      case "sakura":
        // Sakura tradicional japonés - claro y bonito
        return "bg-gradient-to-br from-pink-100 via-rose-50 to-pink-50 border-pink-200";
      case "light":
  ...
  const getAccentColors = (themeName: string) => {
    switch (themeName) {
      case "sakura":
        // Rosas suaves tradicionales
        return ["#ffb6c1", "#ff85a2", "#ff6b8b"];
      case "light":
