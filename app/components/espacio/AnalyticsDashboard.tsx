...
export default function AnalyticsDashboard() {
  ...
  if (loading) {
    return (
      <div className="space-y-8" aria-busy="true" aria-label="Cargando estadísticas">
        {/* Overview cards skeleton — mismo grid que el contenido real */}
