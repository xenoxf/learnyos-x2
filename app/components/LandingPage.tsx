        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <div className={styles.heroCTA}>
              <Link className={styles.heroCTAButton} href="/auth">
                Comenzar Ahora - Gratis
              </Link>
            </div>
            <div className={styles.heroStats}>
              {stats.map((stat, index) => <div key={index} className={styles.heroStat}>
            ...
            <div className={styles.heroImageBox}>
              <div className={styles.heroImageContent}>
                <div className={styles.heroImageHeader}>
                  <div className={`${styles.heroImageHeaderDot} ${styles.heroImageHeaderDotRed}`}></div>
                  <div className={`${styles.heroImageHeaderDot} ${styles.heroImageHeaderDotYellow}`}></div>
                  <div className={`${styles.heroImageHeaderDot} ${styles.heroImageHeaderDotGreen}`}></div>
                </div>
                <div className={styles.heroImageBars}>
                  <div className={`${styles.heroImageBar} ${styles.heroImageBar1}`}></div>
                  <div className={`${styles.heroImageBar} ${styles.heroImageBar2}`}></div>
                  <div className={`${styles.heroImageBar} ${styles.heroImageBar3}`}></div>
                  <div className={styles.heroImageGrid}>
                    <div className={`${styles.heroImageGridItem} ${styles.heroImageGridItem1}`}>
                      <span>🤖</span>
                    </div>
                    <div className={`${styles.heroImageGridItem} ${styles.heroImageGridItem2}`}>
                      <span>📚</span>
                    </div>
                  </div>
                </div>
      ...
      <section className={styles.featuresSection}>
        <div className={styles.featuresSectionContent}>
          ...
          <div className={styles.featuresGrid}>
            {features.map((feature, index) => <div key={index} className={styles.featureCard}>
                <div className={styles.featureCardHeader}>
                  <div className={`${styles.featureCardIcon} ${styles[feature.gradient]}`}>
                    {feature.icon}
                  </div>
