...
import { X, Trash2, Lock, Globe, User, FileText, LogOut, Bell, Palette, Shield, AlertTriangle, Settings } from "lucide-react";
    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          <button onClick={onClose} className={styles.backBtn} type="button" aria-label="Volver">
            <X size={24} />
          </button>
