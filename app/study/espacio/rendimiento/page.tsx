...
import { RefreshCw, AlertTriangle, FileText, TrendingUp, User, X, Check, XCircle } from "lucide-react";
        ...
        <div className={styles.modalOverlay} onClick={handleCloseDetail}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              ...
              <button className={styles.modalClose} onClick={handleCloseDetail} type="button" aria-label="Cerrar">
                <X size={20} />
              </button>
            </div>
            <div className={styles.modalBody}>
              ...
              <div className={styles.modalInfo}>
                ...
                <span className={styles.modalInfoValue} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  {user?.picture ? (
                    <Image src={user.picture} alt="" width={24} height={24} style={{ borderRadius: "50%" }} />
                  ) : (
                    <div style={{ width: 24, height: 24, borderRadius: "50%", background: "hsl(var(--primary) / 0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.7rem", fontWeight: 700 }}>
              ...
              <div className={styles.modalInfo}>
                ...
                <span className={styles.modalInfoValue}>
                  {new Date(selectedAttempt.attemptedAt).toLocaleDateString("es-CO", {
                    day: "numeric",
                    month: "long",
                    year: "numeric",
                  })}
              ...
              <div className={styles.modalInfo}>
                <span className={styles.modalInfoLabel}>Respuestas correctas</span>
                <span className={styles.modalInfoValue}>
              ...
              {/* Feedback Visual */}
              <div style={{ marginTop: "1rem", padding: "1rem", background: "hsl(var(--muted) / 0.15)", borderRadius: "0.75rem", border: "1px solid hsl(var(--border))" }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.75rem" }}>
                  <span style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "hsl(var(--success))", fontWeight: 600 }}>
                    <Check size={18} /> Correctas: {selectedAttempt.correctAnswers}
                  </span>
                  <span style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "hsl(var(--destructive))", fontWeight: 600 }}>
                    <XCircle size={18} /> Incorrectas: {selectedAttempt.totalQuestions - selectedAttempt.correctAnswers}
                  </span>
                </div>
